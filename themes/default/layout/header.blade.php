<header>
  ...
  <div class="top-wrap">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <div class="left d-flex align-items-center">
        ...
        <span class="motobayan-top-note d-none d-md-inline">Rider-ready parts • Presyong PHP • Para sa araw-araw na biyahe</span>
  ...
  <div class="header-content d-none d-lg-block">
    <div class="container-fluid navbar-expand-lg">
      ...
      <div class="logo"><a href="{{ shop_route('home.index') }}">
          <img src="{{ image_origin(system_setting('base.logo')) }}" class="img-fluid" alt="{{ system_setting('base.meta_title', 'MotoBayan PH') }}"></a>
      </div>
      @endhookwrapper
      <div class="menu-wrap">
      ...
      <div class="right-btn">
        <ul class="navbar-nav flex-row">
          ...
          <li class="nav-item"><a href="#offcanvas-search-top" data-bs-toggle="offcanvas" class="nav-link" aria-label="Search products"><img src="{{ asset('image/icons/search.svg') }}" class="img-fluid" alt=""></a></li>
          <li class="nav-item"><a href="{{ shop_route('account.wishlist.index') }}" class="nav-link" aria-label="Wishlist"><img src="{{ asset('image/icons/favorite.svg') }}" class="img-fluid" alt=""></a></li>
          <li class="nav-item dropdown">
            <a href="{{ shop_route('account.index') }}" class="nav-link" aria-label="Account"><img src="{{ asset('image/icons/account.svg') }}" class="img-fluid" alt=""></a>
            <ul class="dropdown-menu">
              @auth('web_shop')
                ...
                <li>
                  <form action="{{ shop_route('logout') }}" method="POST" class="m-0">
                    @csrf
                    <button type="submit" class="dropdown-item"><i class="bi bi-box-arrow-left me-1"></i>
                      {{ __('common.sign_out') }}</button>
                  </form>
                </li>
              @else
          ...
          <li class="nav-item">
            <a
              ...
              href="javascript:void(0);" role="button" aria-label="Open cart">
              <img src="{{ asset('image/icons/cart.svg') }}" class="img-fluid" alt="">
  ...
  <div class="header-mobile d-lg-none">
    <div class="mobile-content">
      <div class="left">
        <button type="button" class="mobile-open-menu btn p-0" aria-label="Open menu"><img src="{{ asset('image/icons/menu.svg') }}" alt="" class="img-fluid"></button>
        <button type="button" class="mobile-open-search btn p-0" data-bs-target="#offcanvas-search-top" data-bs-toggle="offcanvas" aria-label="Search products">
             <img src="{{ asset('image/icons/search.svg') }}" class="img-fluid" alt="">
        </button>
      </div>
