# MotoBayan PH Remodel

This copy of BeikeShop has been remodeled into **MotoBayan PH**, a Philippines-focused motorcycle parts and riding-gear demo store. The underlying BeikeShop/Laravel commerce engine and license are preserved. See **[Remodel Notes](docs/REMODEL_NOTES.md)**, **[System Architecture](docs/ARCHITECTURE.md)** and **[Security Design](docs/SECURITY.md)** for the customizations and production-hardening guidance.

> `MotoBayan.ph` is a proposed project/site name only; this repository does not assert domain registration availability.
